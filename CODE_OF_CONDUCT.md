...
This Code of Conduct applies within all Aerith AI spaces, including GitHub repositories, social media platforms, communication channels, and any other community-related interaction, both online and offline.

## Reporting Issues

If you experience or witness behavior that violates this Code of Conduct, please report it to the maintainers at **Aerith_AI@support.com**. Reports will be reviewed promptly, and actions will be taken to address the issue while maintaining confidentiality.
...
**Consequence**: Temporary exclusion from Aerith AI spaces.

### 4. Permanent Ban
**Community Impact**: Repeated or severe violations, including harassment or threats.  
**Consequence**: Permanent removal from the Aerith AI community and revocation of all access rights.

## Acknowledgements

This Code of Conduct is adapted from the Contributor Covenant, version 2.1, and tailored to fit the Aerith AI community. We thank all contributors who help maintain an inclusive and respectful space.

---

**Aerith AI**: Combining the artistry of manga with the power of AI—together, let's build something amazing!
